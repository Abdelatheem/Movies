...
function TextAlignmentExample(props) {
  return (
    <Block title={props.title} description={props.description}>
      <View>
...
class Setting extends React.Component {
  ...
  _linearTap(refName, e) {
    ...
    const toMaxDistance =
      (this.state.isRTL ? -1 : 1) * (this.state.containerWidth / 2 - offset);
...
RTLExample.title = "RTLExample";
RTLExample.description =
