...
class Welcome extends Component {
  ...
  renderButton() {
    if (this.props.loading) {
      ...
      return <Button style={{ borderRadius: 20 }} buttonText='Login' onPress={this.login.bind(this)} />;
    }
  }
  ...
  render() {
    return (
      <ScrollView style={styles.container}>
          <Image source={require('../resources/images/logo.png')} style={{ alignSelf: 'center', width: '80%', resizeMode: 'contain' }} />
        <Card>
          <CardSection>
          </CardSection>
          ...
          <Button style={styles.orangeButton} buttonText={'Login as Guest >>'} onPress={} />
          </View>
        </Card>
      </ScrollView>
    );
