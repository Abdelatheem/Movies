...
class MovieDetail extends Component {
    ...
    renderDetails(){
        ...
        if(this.props.movieDetails){
            const {backdrop_path, adult, budget, revenue, popularity, genres, status, spoken_languages, overview, original_title, release_date, vote_count, vote_average, tagline } = this.props.movieDetails
            return  <View>
                    ...
                    <View style={styles.separator}/>
                    <Text style={styles.movieTitle1}>Movie: </Text>
                    <Text style={styles.movieTitle3}>{status}</Text>
                    <View style={styles.separator}/>
