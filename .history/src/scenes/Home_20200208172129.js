...
import { getMovieGeners, getMoviesByGener, renderMovieDetail } from '../actions';
...
export default connect(mapStateToProps, { getMovieGeners, getMoviesByGener, renderMovieDetail })(Home);
