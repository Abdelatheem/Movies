...
class MovieDetail extends Component {
    ...
    renderDetails(){
        ...
        if(this.props.movieDetails){
            const {backdrop_path, adult, budget,  genres, status, spoken_languages, overview, original_title, release_date, vote_count, vote_average, tagline } = this.props.movieDetails
            return  <View>
                    ...
                    <View style={{flexDirection: 'column'}}>{spoken_languages.map(l => <Text style={styles.movieTitle3}>{l.name} </Text>)}</View>
                    <View style={styles.separator}/>
                    <Text style={styles.movieTitle1}>Adult: </Text>
                    <Text style={styles.movieTitle3}>{adult}</Text>
                    <View style={styles.separator}/>
                    <Text style={styles.movieTitle1}>Status: </Text>
                    <Text style={styles.movieTitle3}>{status}</Text>
                    <View style={styles.separator}/>
