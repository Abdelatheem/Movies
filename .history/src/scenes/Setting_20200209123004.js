  ...
  render() {
    return (
      <ScrollView style={styles.container}>
          ...
          <Text style={styles.settingTitle1}>{this.state.Directions ? 'Left To Right' : 'Right To Left'}</Text>
          <Switch trackColor={{true: null, false: '#cccccc'}} style={{marginStart: '2%'}} onValueChange = {()=> this.changeDirections()} value = {this.state.Directions}/>
          </View>
          </Card>
      </ScrollView>
    );
