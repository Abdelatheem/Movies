...
class MovieDetail extends Component {
    ...
    renderDetails(){
        ...
        if(this.props.movieDetails){
            const {backdrop_path, genres, original_title, release_date, vote_count, vote_average, tagline } = this.props.movieDetails
            return  <View>
                    ...
                    <View style={styles.separator}/>
                    <Text style={styles.movieTitle1}>vote_average: </Text>
                    <Text style={styles.movieTitle3}>{vote_average}</Text>
                    <View style={styles.separator}/>
                    </Card>
                </View>
        } else {
