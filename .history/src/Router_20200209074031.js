...
class RouterComponent extends Component {
  render(){
    return (
      <Router>
        <Scene key='root' navigationBarStyle={styles.navbarStyle} titleStyle={styles.titleStyle} leftButtonTextStyle={styles.leftButtonTextStyle} rightButtonTextStyle={styles.leftButtonTextStyle} leftTitle='Back'>
          <Scene key='Welcome' component={Welcome} hideNavBar initial />
          <Scene title="" key='MovieDetailScreen' component={MovieDetailScreen} />
