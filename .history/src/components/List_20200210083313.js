...
class Item extends PureComponent {
    ...
    render() {
        console.log(this.props.item.item.title);
        return (
            <View key={this.props.item.item.id} style={{ width: 130 }}>
                <TouchableOpacity onPress={() => { !this.state.inClick ? this.props.moveDetails(this.props.item.item.id) : null }}  disabled={isDisabled}>
                    <Image
